...
namespace EcommerceV4.Infrastructure.Migrations
{
    ...
    [Migration("20250927170108_addCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceV4.Domain.Aggregates.CartAggregate.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EcommerceV4.Domain.Aggregates.CartAggregate.CartDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EcommerceV4.Domain.Aggregates.RefetchTokenAggregate.RefetchToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("RefetchToken", (string)null);
                });
            ...
            modelBuilder.Entity("EcommerceV4.Domain.Aggregates.CartAggregate.CartDetail", b =>
                {
                    b.HasOne("EcommerceV4.Domain.Aggregates.CartAggregate.Cart", "Cart")
            ...
            modelBuilder.Entity("EcommerceV4.Domain.Aggregates.UserAggregate.User", b =>
                {
                    ...
                    b.OwnsOne("EcommerceV4.Domain.Aggregates.UserAggregate.ValueObjects.EmailObject", "Email", b1 =>
                        {
